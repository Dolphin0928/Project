				...
				<div class="col-lg-10">
					<ul
						...
						<li class="nav-item m-2" role="presentation"><a
							...
							aria-controls="pills-how-much-does-it-costs" aria-selected="true">
								旅行的意義?</a></li>
						<li class="nav-item m-2" role="presentation"><a
							class="nav-link btn btn-outline-primary effect-none text-dark "
							id="pills-how-do-i-repay-tab" data-bs-toggle="pill"
							href="#pills-how-do-i-repay" role="tab"
							aria-controls="pills-how-do-i-repay" aria-selected="true">
								旅途的終點?</a></li>
					</ul>
					...
					<div
						...
						<div class="accordion-item p-1 mb-2">
							...
							<div id="collapse-3e13e9676a9cd6a6f8bfbe6e1e9fc0881ef247b3"
								...
								data-bs-parent="#accordionFAQ">
								<div class="accordion-body py-0 content">
									了解目的地的健康和安全信息，如疫苗接種、當地的醫療服務及緊急聯絡方式。
				...
				<div class="col-lg-4 mt-4 mt-lg-0">
					<div
						...
						<div class="block mx-0 mx-lg-3 mt-0">
							<h4 class="h5">還有其他需要協助的嗎?</h4>
							<div class="content">
								立即來電洽詢 <br> <a
									href="tel:3345678-3345678">3345678-3345678</a> <br>Monday - Friday
								<br>早上9點 - 晚上8點 
							</div>
						</div>
						<div class="block mx-0 mx-lg-3 mt-4">
							<h4 class="h5">台中總部</h4>
							<div class="content">
								台中市彌敦道 <br>36-44號 <br>Krist Tsai
							</div>
						</div>
<!-- 						<div class="block mx-0 mx-lg-3 mt-4"> -->
			...
			<div class="row justify-content-between">
				<div class="col-lg-2 col-md-4 col-6 mb-4">
					<div class="footer-widget">
						<h5 class="mb-4 text-primary font-secondary">服務</h5>
